...
public class DeviceMessage {
     ...
     */
    public static Message newNearbyMessage(String instanceId,String Body) {
        DeviceMessage deviceMessage = new DeviceMessage(instanceId,Body);
        return new Message(gson.toJson(deviceMessage).getBytes(Charset.forName("UTF-8")));
    }
    ...
    private DeviceMessage(String uuid,String Body) {
        mUUID = uuid;
        mMessageBody = Build.MODEL+Body;
